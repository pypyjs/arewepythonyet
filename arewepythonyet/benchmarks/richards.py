# This is a lightly edited version of "unladen_swallow/performance/richards.py"
# from the pypy benchmarks repository (https://bitbucket.org/pypy/benchmarks/)
# and is redistributed under the terms of the PSF license.
