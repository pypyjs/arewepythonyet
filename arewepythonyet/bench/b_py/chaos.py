# This is a lightly edited version of "own/chaos.py" from the pypy
# benchmarks repository (https://bitbucket.org/pypy/benchmarks/) and
# is redistributed under the terms of the MIT license.
